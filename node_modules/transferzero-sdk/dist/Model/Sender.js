...
var _PoliticallyExposedPerson = _interopRequireDefault(require("./PoliticallyExposedPerson"));
var _SenderState = _interopRequireDefault(require("./SenderState"));
 ...
 */var Sender = /*#__PURE__*/function () {/**
   ...
   */function Sender(country, street, postalCode, city, email, ip, documents) {_classCallCheck(this, Sender);Sender.initialize(this, country, street, postalCode, city, email, ip, documents);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(Sender, null, [{ key: "initialize", value: function initialize(obj, country, street, postalCode, city, email, ip, documents) {
      obj['country'] = country;
      obj['street'] = street;
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('state')) {
          obj['state'] = _SenderState["default"].constructFromObject(data['state']);
        }
        ...
        if (data.hasOwnProperty('phone_country')) {
          obj['phone_country'] = _ApiClient["default"].convertToType(data['phone_country'], 'String');
        }
        ...
        if (data.hasOwnProperty('address_description')) {
          obj['address_description'] = _ApiClient["default"].convertToType(data['address_description'], 'String');
        }
        if (data.hasOwnProperty('identification_number')) {
          obj['identification_number'] = _ApiClient["default"].convertToType(data['identification_number'], 'String');
        }
        if (data.hasOwnProperty('identification_type')) {
          obj['identification_type'] = _ApiClient["default"].convertToType(data['identification_type'], 'String');
        }
        if (data.hasOwnProperty('lang')) {
          obj['lang'] = _ApiClient["default"].convertToType(data['lang'], 'String');
        }
        ...
        if (data.hasOwnProperty('birth_date')) {
          obj['birth_date'] = _ApiClient["default"].convertToType(data['birth_date'], 'Date');
        }
        ...
        if (data.hasOwnProperty('legal_entity_type')) {
          obj['legal_entity_type'] = _ApiClient["default"].convertToType(data['legal_entity_type'], 'String');
        }
        if (data.hasOwnProperty('registration_date')) {
          obj['registration_date'] = _ApiClient["default"].convertToType(data['registration_date'], 'Date');
        }
        ...
        if (data.hasOwnProperty('nature_of_business')) {
          obj['nature_of_business'] = _ApiClient["default"].convertToType(data['nature_of_business'], 'String');
        }
        if (data.hasOwnProperty('source_of_funds')) {
          obj['source_of_funds'] = _ApiClient["default"].convertToType(data['source_of_funds'], 'String');
        }
        if (data.hasOwnProperty('custom_source_of_funds')) {
          obj['custom_source_of_funds'] = _ApiClient["default"].convertToType(data['custom_source_of_funds'], 'String');
        }
        if (data.hasOwnProperty('core_business_activity')) {
          obj['core_business_activity'] = _ApiClient["default"].convertToType(data['core_business_activity'], 'String');
        }
        if (data.hasOwnProperty('purpose_of_opening_account')) {
          obj['purpose_of_opening_account'] = _ApiClient["default"].convertToType(data['purpose_of_opening_account'], 'String');
        }
        if (data.hasOwnProperty('office_phone')) {
          obj['office_phone'] = _ApiClient["default"].convertToType(data['office_phone'], 'String');
        }
        if (data.hasOwnProperty('vat_registration_number')) {
          obj['vat_registration_number'] = _ApiClient["default"].convertToType(data['vat_registration_number'], 'String');
        }
        if (data.hasOwnProperty('financial_regulator')) {
          obj['financial_regulator'] = _ApiClient["default"].convertToType(data['financial_regulator'], 'String');
        }
        if (data.hasOwnProperty('regulatory_licence_number')) {
          obj['regulatory_licence_number'] = _ApiClient["default"].convertToType(data['regulatory_licence_number'], 'String');
        }
        if (data.hasOwnProperty('contact_person_email')) {
          obj['contact_person_email'] = _ApiClient["default"].convertToType(data['contact_person_email'], 'String');
        }
        if (data.hasOwnProperty('trading_country')) {
          obj['trading_country'] = _ApiClient["default"].convertToType(data['trading_country'], 'String');
        }
        if (data.hasOwnProperty('trading_address')) {
          obj['trading_address'] = _ApiClient["default"].convertToType(data['trading_address'], 'String');
        }
        if (data.hasOwnProperty('trading_name')) {
          obj['trading_name'] = _ApiClient["default"].convertToType(data['trading_name'], 'String');
        }
        if (data.hasOwnProperty('number_monthly_transactions')) {
          obj['number_monthly_transactions'] = _ApiClient["default"].convertToType(data['number_monthly_transactions'], 'String');
        }
        if (data.hasOwnProperty('amount_monthly_transactions')) {
          obj['amount_monthly_transactions'] = _ApiClient["default"].convertToType(data['amount_monthly_transactions'], 'String');
        }
        ...
        if (data.hasOwnProperty('onboarding_status')) {
          obj['onboarding_status'] = _ApiClient["default"].convertToType(data['onboarding_status'], 'String');
        }
        if (data.hasOwnProperty('politically_exposed_people')) {
          obj['politically_exposed_people'] = _ApiClient["default"].convertToType(data['politically_exposed_people'], [_PoliticallyExposedPerson["default"]]);
        }
        if (data.hasOwnProperty('external_id')) {
          obj['external_id'] = _ApiClient["default"].convertToType(data['external_id'], 'String');
        }
        if (data.hasOwnProperty('city_of_birth')) {
          obj['city_of_birth'] = _ApiClient["default"].convertToType(data['city_of_birth'], 'String');
        }
        ...
        if (data.hasOwnProperty('sales_lead_id')) {
          obj['sales_lead_id'] = _ApiClient["default"].convertToType(data['sales_lead_id'], 'String');
        }
        if (data.hasOwnProperty('created_at')) {
          obj['created_at'] = _ApiClient["default"].convertToType(data['created_at'], 'String');
        }
        if (data.hasOwnProperty('company_office_number')) {
          obj['company_office_number'] = _ApiClient["default"].convertToType(data['company_office_number'], 'String');
        }
        if (data.hasOwnProperty('company_office_number_country')) {
          obj['company_office_number_country'] = _ApiClient["default"].convertToType(data['company_office_number_country'], 'String');
        }
        if (data.hasOwnProperty('aml_officer_email')) {
          obj['aml_officer_email'] = _ApiClient["default"].convertToType(data['aml_officer_email'], 'String');
        }
        if (data.hasOwnProperty('aml_officer_phone')) {
          obj['aml_officer_phone'] = _ApiClient["default"].convertToType(data['aml_officer_phone'], 'String');
        }
        if (data.hasOwnProperty('aml_officer_phone_country')) {
          obj['aml_officer_phone_country'] = _ApiClient["default"].convertToType(data['aml_officer_phone_country'], 'String');
        }
        if (data.hasOwnProperty('company_website_url')) {
          obj['company_website_url'] = _ApiClient["default"].convertToType(data['company_website_url'], 'String');
        }
        if (data.hasOwnProperty('number_of_employees_in_company')) {
          obj['number_of_employees_in_company'] = _ApiClient["default"].convertToType(data['number_of_employees_in_company'], 'String');
        }
        if (data.hasOwnProperty('list_of_countries_of_operation')) {
          obj['list_of_countries_of_operation'] = _ApiClient["default"].convertToType(data['list_of_countries_of_operation'], ['String']);
        }
        if (data.hasOwnProperty('estimated_annual_revenue_turnover')) {
          obj['estimated_annual_revenue_turnover'] = _ApiClient["default"].convertToType(data['estimated_annual_revenue_turnover'], 'String');
        }
        if (data.hasOwnProperty('declaration')) {
          obj['declaration'] = _ApiClient["default"].convertToType(data['declaration'], 'String');
        }
      }
      return obj;
    } }]);}();
