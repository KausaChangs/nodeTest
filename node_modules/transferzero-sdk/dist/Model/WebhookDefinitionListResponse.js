 ...
 * @version 1.35.1
 */var WebhookDefinitionListResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>WebhookDefinitionListResponse</code>.
   * @alias module:Model/WebhookDefinitionListResponse
   */function WebhookDefinitionListResponse() {_classCallCheck(this, WebhookDefinitionListResponse);WebhookDefinitionListResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(WebhookDefinitionListResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _ApiClient["default"].convertToType(data['object'], [_WebhookDefinition["default"]]);
        }
 ...
 */
WebhookDefinitionListResponse.prototype['meta'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=WebhookDefinitionListResponse.js.map