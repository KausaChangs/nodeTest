 ...
 * @version 1.35.1
 */var PayoutMethodListResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>PayoutMethodListResponse</code>.
   * @alias module:Model/PayoutMethodListResponse
   */function PayoutMethodListResponse() {_classCallCheck(this, PayoutMethodListResponse);PayoutMethodListResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(PayoutMethodListResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _ApiClient["default"].convertToType(data['object'], [_PayoutMethod["default"]]);
        }
 ...
 */
PayoutMethodListResponse.prototype['meta'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=PayoutMethodListResponse.js.map