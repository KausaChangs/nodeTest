 ...
 * @version 1.35.1
 */var ApiLogListResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>ApiLogListResponse</code>.
   * @alias module:Model/ApiLogListResponse
   */function ApiLogListResponse() {_classCallCheck(this, ApiLogListResponse);ApiLogListResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(ApiLogListResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _ApiClient["default"].convertToType(data['object'], [_ApiLog["default"]]);
        }
 ...
 */
ApiLogListResponse.prototype['meta'] = undefined;var _default = exports["default"] =
...
ApiLogListResponse;
//# sourceMappingURL=ApiLogListResponse.js.map