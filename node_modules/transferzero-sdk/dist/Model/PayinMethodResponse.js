 ...
 * @version 1.35.1
 */var PayinMethodResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>PayinMethodResponse</code>.
   * @alias module:Model/PayinMethodResponse
   */function PayinMethodResponse() {_classCallCheck(this, PayinMethodResponse);PayinMethodResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(PayinMethodResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _PayinMethod["default"].constructFromObject(data['object']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
PayinMethodResponse.prototype['object'] = undefined;var _default = exports["default"] =
...
PayinMethodResponse;
//# sourceMappingURL=PayinMethodResponse.js.map