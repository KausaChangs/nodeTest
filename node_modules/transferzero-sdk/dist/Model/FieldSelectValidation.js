 ...
 * @version 1.35.1
 */var FieldSelectValidation = /*#__PURE__*/function () {/**
   * Constructs a new <code>FieldSelectValidation</code>.
   * @alias module:Model/FieldSelectValidation
   */function FieldSelectValidation() {_classCallCheck(this, FieldSelectValidation);FieldSelectValidation.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(FieldSelectValidation, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('in')) {
          obj['in'] = _ApiClient["default"].convertToType(data['in'], Object);
        }
        if (data.hasOwnProperty('allow_blank')) {
          obj['allow_blank'] = _ApiClient["default"].convertToType(data['allow_blank'], 'Boolean');
        }
      }
      return obj;
    } }]);}();
 ...
 */
FieldSelectValidation.prototype['allow_blank'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=FieldSelectValidation.js.map