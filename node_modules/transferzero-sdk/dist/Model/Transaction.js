...
var _PayinMethod = _interopRequireDefault(require("./PayinMethod"));
var _Recipient = _interopRequireDefault(require("./Recipient"));
var _Sender = _interopRequireDefault(require("./Sender"));
var _TransactionState = _interopRequireDefault(require("./TransactionState"));
var _TransactionTraits = _interopRequireDefault(require("./TransactionTraits"));
 ...
 */var Transaction = /*#__PURE__*/function () {/**
   ...
   */function Transaction(inputCurrency, sender, recipients) {_classCallCheck(this, Transaction);Transaction.initialize(this, inputCurrency, sender, recipients);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(Transaction, null, [{ key: "initialize", value: function initialize(obj, inputCurrency, sender, recipients) {
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('input_currency')) {
          obj['input_currency'] = _ApiClient["default"].convertToType(data['input_currency'], 'String');
        }
        if (data.hasOwnProperty('payin_methods')) {
          obj['payin_methods'] = _ApiClient["default"].convertToType(data['payin_methods'], [_PayinMethod["default"]]);
        }
        if (data.hasOwnProperty('metadata')) {
          obj['metadata'] = _ApiClient["default"].convertToType(data['metadata'], Object);
        }
        if (data.hasOwnProperty('sender')) {
          obj['sender'] = _Sender["default"].constructFromObject(data['sender']);
        }
        if (data.hasOwnProperty('recipients')) {
          obj['recipients'] = _ApiClient["default"].convertToType(data['recipients'], [_Recipient["default"]]);
        }
        if (data.hasOwnProperty('traits')) {
          obj['traits'] = _TransactionTraits["default"].constructFromObject(data['traits']);
        }
        if (data.hasOwnProperty('state')) {
          obj['state'] = _TransactionState["default"].constructFromObject(data['state']);
        }
        if (data.hasOwnProperty('input_amount')) {
          obj['input_amount'] = _ApiClient["default"].convertToType(data['input_amount'], 'Number');
        }
        if (data.hasOwnProperty('payin_reference')) {
          obj['payin_reference'] = _ApiClient["default"].convertToType(data['payin_reference'], 'String');
        }
        ...
        if (data.hasOwnProperty('due_amount')) {
          obj['due_amount'] = _ApiClient["default"].convertToType(data['due_amount'], 'Number');
        }
 ...
 */
Transaction.prototype['errors'] = undefined;var _default = exports["default"] =
