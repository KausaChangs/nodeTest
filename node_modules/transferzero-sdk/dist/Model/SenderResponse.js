 ...
 * @version 1.35.1
 */var SenderResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>SenderResponse</code>.
   * @alias module:Model/SenderResponse
   */function SenderResponse() {_classCallCheck(this, SenderResponse);SenderResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(SenderResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _Sender["default"].constructFromObject(data['object']);
        }
        if (data.hasOwnProperty('meta')) {
          obj['meta'] = _SenderResponseMeta["default"].constructFromObject(data['meta']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
SenderResponse.prototype['meta'] = undefined;var _default = exports["default"] =
...
SenderResponse;
//# sourceMappingURL=SenderResponse.js.map