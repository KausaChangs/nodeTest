 ...
 * @version 1.35.1
 */var RecipientRequest = /*#__PURE__*/function () {/**
   * Constructs a new <code>RecipientRequest</code>.
   * @alias module:Model/RecipientRequest
   */function RecipientRequest() {_classCallCheck(this, RecipientRequest);RecipientRequest.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(RecipientRequest, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('recipient')) {
          obj['recipient'] = _Recipient["default"].constructFromObject(data['recipient']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
RecipientRequest.prototype['recipient'] = undefined;var _default = exports["default"] =
...
RecipientRequest;
//# sourceMappingURL=RecipientRequest.js.map