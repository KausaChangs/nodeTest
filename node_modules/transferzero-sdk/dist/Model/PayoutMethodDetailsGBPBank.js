 ...
 * @version 1.35.1
 */var PayoutMethodDetailsGBPBank = /*#__PURE__*/function () {/**
   ...
   */function PayoutMethodDetailsGBPBank(firstName, lastName) {_classCallCheck(this, PayoutMethodDetailsGBPBank);PayoutMethodDetailsGBPBank.initialize(this, firstName, lastName);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(PayoutMethodDetailsGBPBank, null, [{ key: "initialize", value: function initialize(obj, firstName, lastName) {
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('sort_code')) {
          obj['sort_code'] = _ApiClient["default"].convertToType(data['sort_code'], 'String');
        }
        ...
        if (data.hasOwnProperty('narration')) {
          obj['narration'] = _ApiClient["default"].convertToType(data['narration'], 'String');
        }
 ...
 */
PayoutMethodDetailsGBPBank.prototype['birth_date'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=PayoutMethodDetailsGBPBank.js.map