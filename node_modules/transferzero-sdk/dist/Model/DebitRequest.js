 ...
 * @version 1.35.1
 */var DebitRequest = /*#__PURE__*/function () {/**
   * Constructs a new <code>DebitRequest</code>.
   * @alias module:Model/DebitRequest
   */function DebitRequest() {_classCallCheck(this, DebitRequest);DebitRequest.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(DebitRequest, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('debit')) {
          obj['debit'] = _Debit["default"].constructFromObject(data['debit']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
DebitRequest.prototype['debit'] = undefined;var _default = exports["default"] =
