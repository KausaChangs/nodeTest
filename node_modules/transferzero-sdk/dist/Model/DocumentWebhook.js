...
var _DocumentWebhookAllOf = _interopRequireDefault(require("./DocumentWebhookAllOf"));
 ...
 * @version 1.35.1
 */var DocumentWebhook = /*#__PURE__*/function () {/**
   ...
   */function DocumentWebhook(webhook, event, object) {_classCallCheck(this, DocumentWebhook);_Webhook["default"].initialize(this, webhook, event, object);_DocumentWebhookAllOf["default"].initialize(this);DocumentWebhook.initialize(this, webhook, event, object);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(DocumentWebhook, null, [{ key: "initialize", value: function initialize(obj, webhook, event, object) {
      obj['webhook'] = webhook;
      obj['event'] = event;
      obj['object'] = object;
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        _DocumentWebhookAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _Document["default"].constructFromObject(data['object']);
        }
      }
      return obj;
    } }]);}();
 ...
 * @member {module:Model/Document} object
 */
_DocumentWebhookAllOf["default"].prototype['object'] = undefined;var _default = exports["default"] =




DocumentWebhook;
//# sourceMappingURL=DocumentWebhook.js.map