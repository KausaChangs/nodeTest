...
var _RecipientWebhookAllOf = _interopRequireDefault(require("./RecipientWebhookAllOf"));
 ...
 * @version 1.35.1
 */var RecipientWebhook = /*#__PURE__*/function () {/**
   ...
   */function RecipientWebhook(webhook, event, object) {_classCallCheck(this, RecipientWebhook);_Webhook["default"].initialize(this, webhook, event, object);_RecipientWebhookAllOf["default"].initialize(this);RecipientWebhook.initialize(this, webhook, event, object);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(RecipientWebhook, null, [{ key: "initialize", value: function initialize(obj, webhook, event, object) {
      obj['webhook'] = webhook;
      obj['event'] = event;
      obj['object'] = object;
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        _RecipientWebhookAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _Recipient["default"].constructFromObject(data['object']);
        }
      }
      return obj;
    } }]);}();
 ...
 * @member {module:Model/Recipient} object
 */
_RecipientWebhookAllOf["default"].prototype['object'] = undefined;var _default = exports["default"] =




RecipientWebhook;
//# sourceMappingURL=RecipientWebhook.js.map