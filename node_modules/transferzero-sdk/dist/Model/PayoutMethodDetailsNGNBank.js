 ...
 * @version 1.35.1
 */var PayoutMethodDetailsNGNBank = /*#__PURE__*/function () {/**
   ...
   */function PayoutMethodDetailsNGNBank(firstName, lastName, bankCode, bankAccount) {_classCallCheck(this, PayoutMethodDetailsNGNBank);PayoutMethodDetailsNGNBank.initialize(this, firstName, lastName, bankCode, bankAccount);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(PayoutMethodDetailsNGNBank, null, [{ key: "initialize", value: function initialize(obj, firstName, lastName, bankCode, bankAccount) {
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('bank_account_type')) {
          obj['bank_account_type'] = _PayoutMethodBankAccountTypeEnum["default"].constructFromObject(data['bank_account_type']);
        }
 ...
 */
PayoutMethodDetailsNGNBank.prototype['birth_date'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=PayoutMethodDetailsNGNBank.js.map