 ...
 * @version 1.35.1
 */var SenderResponseMeta = /*#__PURE__*/function () {/**
   * Constructs a new <code>SenderResponseMeta</code>.
   * @alias module:Model/SenderResponseMeta
   */function SenderResponseMeta() {_classCallCheck(this, SenderResponseMeta);SenderResponseMeta.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(SenderResponseMeta, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('existing')) {
          obj['existing'] = _SenderResponseExisting["default"].constructFromObject(data['existing']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
SenderResponseMeta.prototype['existing'] = undefined;var _default = exports["default"] =
...
SenderResponseMeta;
//# sourceMappingURL=SenderResponseMeta.js.map