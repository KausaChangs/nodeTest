 ...
 * @version 1.35.1
 */var PayoutMethodDetailsKESBank = /*#__PURE__*/function () {/**
   ...
   */function PayoutMethodDetailsKESBank(firstName, lastName, street, bankCode, bankAccount, transferReason, identityCardType, identityCardId) {_classCallCheck(this, PayoutMethodDetailsKESBank);PayoutMethodDetailsKESBank.initialize(this, firstName, lastName, street, bankCode, bankAccount, transferReason, identityCardType, identityCardId);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(PayoutMethodDetailsKESBank, null, [{ key: "initialize", value: function initialize(obj, firstName, lastName, street, bankCode, bankAccount, transferReason, identityCardType, identityCardId) {
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('transfer_reason')) {
          obj['transfer_reason'] = _PayoutMethodTransferReasonEnum["default"].constructFromObject(data['transfer_reason']);
        }
        if (data.hasOwnProperty('identity_card_type')) {
          obj['identity_card_type'] = _PayoutMethodIdentityCardTypeEnum["default"].constructFromObject(data['identity_card_type']);
        }
        if (data.hasOwnProperty('identity_card_id')) {
          obj['identity_card_id'] = _ApiClient["default"].convertToType(data['identity_card_id'], 'String');
        }
        if (data.hasOwnProperty('relationship_to_sender')) {
          obj['relationship_to_sender'] = _ApiClient["default"].convertToType(data['relationship_to_sender'], 'String');
        }
 ...
 */
PayoutMethodDetailsKESBank.prototype['birth_date'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=PayoutMethodDetailsKESBank.js.map