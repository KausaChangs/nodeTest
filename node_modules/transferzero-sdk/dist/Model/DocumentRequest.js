 ...
 * @version 1.35.1
 */var DocumentRequest = /*#__PURE__*/function () {/**
   * Constructs a new <code>DocumentRequest</code>.
   * @alias module:Model/DocumentRequest
   */function DocumentRequest() {_classCallCheck(this, DocumentRequest);DocumentRequest.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(DocumentRequest, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('document')) {
          obj['document'] = _Document["default"].constructFromObject(data['document']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
DocumentRequest.prototype['document'] = undefined;var _default = exports["default"] =
