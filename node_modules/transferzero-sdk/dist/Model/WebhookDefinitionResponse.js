 ...
 * @version 1.35.1
 */var WebhookDefinitionResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>WebhookDefinitionResponse</code>.
   * @alias module:Model/WebhookDefinitionResponse
   */function WebhookDefinitionResponse() {_classCallCheck(this, WebhookDefinitionResponse);WebhookDefinitionResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(WebhookDefinitionResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _WebhookDefinition["default"].constructFromObject(data['object']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
WebhookDefinitionResponse.prototype['object'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=WebhookDefinitionResponse.js.map