 ...
 * @version 1.35.1
 */var WebhookLogListResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>WebhookLogListResponse</code>.
   * @alias module:Model/WebhookLogListResponse
   */function WebhookLogListResponse() {_classCallCheck(this, WebhookLogListResponse);WebhookLogListResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(WebhookLogListResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _ApiClient["default"].convertToType(data['object'], [_WebhookLog["default"]]);
        }
 ...
 */
WebhookLogListResponse.prototype['meta'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=WebhookLogListResponse.js.map