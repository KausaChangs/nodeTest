 ...
 * @version 1.30.3
 */var DebitResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>DebitResponse</code>.
   * @alias module:Model/DebitResponse
   */function DebitResponse() {_classCallCheck(this, DebitResponse);DebitResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(DebitResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _Debit["default"].constructFromObject(data['object']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
DebitResponse.prototype['object'] = undefined;var _default = exports["default"] =
...
DebitResponse;
//# sourceMappingURL=DebitResponse.js.map