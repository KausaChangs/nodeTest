 ...
 */var TransactionResponse = /*#__PURE__*/function () {/**
   ...
   */function TransactionResponse() {_classCallCheck(this, TransactionResponse);TransactionResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(TransactionResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _Transaction["default"].constructFromObject(data['object']);
        }
        if (data.hasOwnProperty('meta')) {
          obj['meta'] = _TransactionResponseMeta["default"].constructFromObject(data['meta']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
TransactionResponse.prototype['meta'] = undefined;var _default = exports["default"] =
