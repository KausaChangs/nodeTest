 ...
 * @version 1.35.1
 */var TransactionListResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>TransactionListResponse</code>.
   * @alias module:Model/TransactionListResponse
   */function TransactionListResponse() {_classCallCheck(this, TransactionListResponse);TransactionListResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(TransactionListResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _ApiClient["default"].convertToType(data['object'], [_Transaction["default"]]);
        }
 ...
 */
TransactionListResponse.prototype['meta'] = undefined;var _default = exports["default"] =
