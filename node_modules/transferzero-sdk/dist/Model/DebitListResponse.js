 ...
 * @version 1.35.1
 */var DebitListResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>DebitListResponse</code>.
   * @alias module:Model/DebitListResponse
   */function DebitListResponse() {_classCallCheck(this, DebitListResponse);DebitListResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(DebitListResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _ApiClient["default"].convertToType(data['object'], [_Debit["default"]]);
        }
 ...
 */
DebitListResponse.prototype['meta'] = undefined;var _default = exports["default"] =
...
DebitListResponse;
//# sourceMappingURL=DebitListResponse.js.map