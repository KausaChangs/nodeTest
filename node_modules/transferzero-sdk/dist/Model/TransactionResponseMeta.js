 ...
 * @version 1.35.1
 */var TransactionResponseMeta = /*#__PURE__*/function () {/**
   * Constructs a new <code>TransactionResponseMeta</code>.
   * @alias module:Model/TransactionResponseMeta
   */function TransactionResponseMeta() {_classCallCheck(this, TransactionResponseMeta);TransactionResponseMeta.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(TransactionResponseMeta, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('existing')) {
          obj['existing'] = _TransactionResponseExisting["default"].constructFromObject(data['existing']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
TransactionResponseMeta.prototype['existing'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=TransactionResponseMeta.js.map