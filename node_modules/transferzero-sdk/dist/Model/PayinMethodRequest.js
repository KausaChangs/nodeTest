 ...
 * @version 1.35.1
 */var PayinMethodRequest = /*#__PURE__*/function () {/**
   * Constructs a new <code>PayinMethodRequest</code>.
   * @alias module:Model/PayinMethodRequest
   */function PayinMethodRequest() {_classCallCheck(this, PayinMethodRequest);PayinMethodRequest.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(PayinMethodRequest, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('payin_method')) {
          obj['payin_method'] = _PayinMethod["default"].constructFromObject(data['payin_method']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
PayinMethodRequest.prototype['payin_method'] = undefined;var _default = exports["default"] =
...
PayinMethodRequest;
//# sourceMappingURL=PayinMethodRequest.js.map