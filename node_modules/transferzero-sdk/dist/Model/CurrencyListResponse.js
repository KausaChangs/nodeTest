 ...
 * @version 1.35.1
 */var CurrencyListResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>CurrencyListResponse</code>.
   * List of possible currencies
   * @alias module:Model/CurrencyListResponse
   */function CurrencyListResponse() {_classCallCheck(this, CurrencyListResponse);CurrencyListResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(CurrencyListResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _ApiClient["default"].convertToType(data['object'], [_Currency["default"]]);
        }
      }
      return obj;
    } }]);}();
 ...
 */
CurrencyListResponse.prototype['object'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=CurrencyListResponse.js.map