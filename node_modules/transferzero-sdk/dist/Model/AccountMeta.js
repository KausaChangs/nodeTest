 ...
 * @version 1.35.1
 */var AccountMeta = /*#__PURE__*/function () {/**
   * Constructs a new <code>AccountMeta</code>.
   * @alias module:Model/AccountMeta
   */function AccountMeta() {_classCallCheck(this, AccountMeta);AccountMeta.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(AccountMeta, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('negative_balance')) {
          obj['negative_balance'] = _ApiClient["default"].convertToType(data['negative_balance'], 'Boolean');
        }
      }
      return obj;
    } }]);}();
 ...
 */
AccountMeta.prototype['negative_balance'] = undefined;var _default = exports["default"] =
...
AccountMeta;
//# sourceMappingURL=AccountMeta.js.map