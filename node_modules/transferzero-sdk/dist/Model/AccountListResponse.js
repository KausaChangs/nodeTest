 ...
 * @version 1.35.1
 */var AccountListResponse = /*#__PURE__*/function () {/**
   * Constructs a new <code>AccountListResponse</code>.
   * @alias module:Model/AccountListResponse
   */function AccountListResponse() {_classCallCheck(this, AccountListResponse);AccountListResponse.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(AccountListResponse, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object')) {
          obj['object'] = _ApiClient["default"].convertToType(data['object'], [_Account["default"]]);
        }
        if (data.hasOwnProperty('meta')) {
          obj['meta'] = _AccountMeta["default"].constructFromObject(data['meta']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
AccountListResponse.prototype['meta'] = undefined;var _default = exports["default"] =
