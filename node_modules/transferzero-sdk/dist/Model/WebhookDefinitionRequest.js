 ...
 * @version 1.35.1
 */var WebhookDefinitionRequest = /*#__PURE__*/function () {/**
   * Constructs a new <code>WebhookDefinitionRequest</code>.
   * @alias module:Model/WebhookDefinitionRequest
   */function WebhookDefinitionRequest() {_classCallCheck(this, WebhookDefinitionRequest);WebhookDefinitionRequest.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(WebhookDefinitionRequest, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('webhook')) {
          obj['webhook'] = _WebhookDefinition["default"].constructFromObject(data['webhook']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
WebhookDefinitionRequest.prototype['webhook'] = undefined;var _default = exports["default"] =
...
//# sourceMappingURL=WebhookDefinitionRequest.js.map