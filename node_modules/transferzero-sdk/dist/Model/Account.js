 ...
 */var Account = /*#__PURE__*/function () {/**
   ...
   */function Account() {_classCallCheck(this, Account);Account.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(Account, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('amount_after_pending')) {
          obj['amount_after_pending'] = _ApiClient["default"].convertToType(data['amount_after_pending'], 'Number');
        }
      }
      return obj;
    } }]);}();
 ...
 */
Account.prototype['amount_after_pending'] = undefined;var _default = exports["default"] =
