 ...
 * @version 1.35.1
 */var PayoutMethodRequest = /*#__PURE__*/function () {/**
   * Constructs a new <code>PayoutMethodRequest</code>.
   * @alias module:Model/PayoutMethodRequest
   */function PayoutMethodRequest() {_classCallCheck(this, PayoutMethodRequest);PayoutMethodRequest.initialize(this);} /**
   * Initializes the fields of this object.
   * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
   * Only for internal use.
   */return _createClass(PayoutMethodRequest, null, [{ key: "initialize", value: function initialize(obj) {
    }
    ...
    function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('payout_method')) {
          obj['payout_method'] = _PayoutMethod["default"].constructFromObject(data['payout_method']);
        }
      }
      return obj;
    } }]);}();
 ...
 */
PayoutMethodRequest.prototype['payout_method'] = undefined;var _default = exports["default"] =
...
PayoutMethodRequest;
//# sourceMappingURL=PayoutMethodRequest.js.map